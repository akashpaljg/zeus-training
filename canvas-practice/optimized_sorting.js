...
getVisibleArea(scrollX, scrollY) {
    ...
    async getData(batchStart){
            try{
                const res = await fetch(`http://localhost:5103/api/check/data/${batchStart}/${this.sortingState.columnName}/${this.sortingState.order}`);
                const response = await res.json();
...
window.onload = async function () {
    ...
    async function getData(){
        try{
            const res = await fetch(`http://localhost:5103/api/check/data/${batchStart}/${sortingState.columnName}/${sortingState.order}`);
            const response = await res.json();
            // console.log(response.data);
            return response.data;
        }catch(error){
